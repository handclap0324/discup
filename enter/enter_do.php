...
$sql = 'INSERT INTO combat_data(combatdate, week, parlor, total, big, reg, money, coin, income) VALUES (:combatdate, :week, :parlor, :total, :big, :reg, :money, :coin, :income)';
...
<div class="container">
    ...
    <p>データベースへの登録が完了しました。</p>
    <a href="enter.php">入力画面へ戻る</a><br><br>
